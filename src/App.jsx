...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Navbar */}
      <nav className="sticky top-0 z-50 flex items-center justify-between px-8 py-1 border-b shadow-sm bg-white/90 backdrop-blur-md">
      ...
      <div className="flex items-center justify-between px-8 py-12 bg-gray-50">
        <div className="max-w-lg">
          <h1 className="text-4xl font-bold mb-4">Discover the clubs of our university</h1>
          <p className="text-gray-500 mb-6">Join clubs, participate in events, and develop your skills</p>
      ...
      <div className="px-8 py-12">
        ...
        <div className="grid grid-cols-4 gap-6">
          {clubsAffiches.slice(0, 4).map(club => (
            <div key={club.id} className="border rounded-xl overflow-hidden shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
      ...
      <div id="clubs" className="px-8 py-12 bg-gray-50">
        ...
        <div className="grid grid-cols-4 gap-6">
          {clubsAffiches.map(club => (
            <div key={club.id} className="border rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
      ...
      <div id="about" className="px-8 py-16 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-12 mb-12">
            <div className="flex-1">
              ...
              <p className="text-gray-500 mb-6">
                ...
                event coordination, and administrative tools simple and trustworthy.
              </p>
              <div className="flex gap-4">
                <button className="bg-[#6600FF] text-white px-6 py-2 rounded-lg hover:bg-purple-800 transition">Explore Clubs</button>
                <button className="border border-gray-300 px-6 py-2 rounded-lg hover:border-[#6600FF] hover:text-[#6600FF] transition">Contact Us</button>
              </div>
            </div>
          ...
          <div className="bg-[#f6f1fc] rounded-xl p-8 mb-12">
            ...
            <p className="text-gray-500 mb-6">
              We help students discover authentic campus experiences and help club leaders run vibrant, organized communities.
            </p>
      ...
      <footer className="bg-[#fbfbfb] border-t px-8 py-10">
        <div className="max-w-6xl mx-auto grid grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">Helping students find belonging and making club management easier for leaders across campuses.</p>
          </div>
          <div>
  ...
  return (
    <Routes>
      ...
      <Route
        path="/login"
        element={
          utilisateur ? <Navigate to="/dashboard" /> : <LoginPage onLogin={handleLogin} />
        }
      />
      <Route
        path="/dashboard"
        element={
          utilisateur ? (
            <DashboardAdmin utilisateur={utilisateur} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
